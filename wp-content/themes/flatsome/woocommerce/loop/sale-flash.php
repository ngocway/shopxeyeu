...
<?php if ( $product->is_on_sale() ) : ?>
	...
	<?php echo apply_filters( 'woocommerce_sale_flash', '<div class="callout badge badge-'.$badge_style.'" ><div class="badge-inner secondary on-sale" style = "background: transparent;"><span class="onsale">' .  $text . '</span></div></div>', $post, $product ); ?>
